...
public class AmazonProjectTC9_VerifyProductCanBeAddedToCartFromProductPage extends BaseClass {
	...
	public void VerifyProductCanBeAddedToCartFromProductPage(String username, String pwd) throws InterruptedException {
