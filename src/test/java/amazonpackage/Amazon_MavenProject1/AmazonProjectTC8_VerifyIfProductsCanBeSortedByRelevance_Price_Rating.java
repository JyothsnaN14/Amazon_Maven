...
public class AmazonProjectTC8_VerifyIfProductsCanBeSortedByRelevance_Price_Rating  extends BaseClass {
	...
	public void VerifyIfProductsCanBeSortedByRelevance_Price_Rating(String username, String pwd) {
		...
		sr1.printAllSortedProducts();
		sr1.sortProductsByPrice();
		sr1.sortProductsByRatingDescending();
