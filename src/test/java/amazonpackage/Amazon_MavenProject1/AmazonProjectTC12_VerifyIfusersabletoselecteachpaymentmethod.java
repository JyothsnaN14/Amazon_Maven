...
public class AmazonProjectTC12_VerifyIfusersabletoselecteachpaymentmethod extends BaseClass {
	...
	@Test(dataProvider="AmazonloginData_CorrectCredentials",dataProviderClass=Amazon_Login_Data_Provider.class,
		...
		public void VerifyIfusersabletoselecteachpaymentmethod(String username, String pwd) throws InterruptedException {
